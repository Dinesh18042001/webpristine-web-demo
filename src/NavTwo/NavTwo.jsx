...
//                     <div class="row justify-content-center row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ms-5">
              ...
              <li className="nav-item ms-3">
                <Link className="nav-link active" to="/assistant">Assistant</Link>
              </li>
                ...
                <ul className="drop_down">
                  <div className="row justify-content-center row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
                    <div className="col text-center">
                      <a href="#">
                        <div className="header-img position-relative">
                          <img src="./assets/header/img1.png" alt="" className="img-fluid" />
                          <div className="header-img-tittle">
                            <h6>Virtual Assistant</h6>
                          </div>
                        </div>
                    ...
                    <div className="col text-center">
                      <a href="#">
                        <div className="header-img position-relative">
                          <img src="./assets/header/img2.png" alt="" className="img-fluid" />
                          <div className="header-img-tittle">
                            <h6>Web Development</h6>
                          </div>
                        </div>
                    ...
                    <div className="col text-center">
                      <a href="#">
                        <div className="header-img position-relative">
                          <img src="./assets/header/img3.png" alt="" className="img-fluid" />
                          <div className="header-img-tittle">
                            <h6>App Development</h6>
                          </div>
                        </div>
                    ...
                    <div className="col text-center">
                      <a href="#">
                        <div className="header-img position-relative">
                          <img src="./assets/header/img4.png" alt="" className="img-fluid" />
                          <div className="header-img-tittle">
                            <h6>Digital Marketing</h6>
                          </div>
                        </div>
                    ...
                    <div className="col text-center">
                      <a href="#">
                        <div className="header-img position-relative">
                          <img src="./assets/header/img5.png" alt="" className="img-fluid" />
                          <div className="header-img-tittle">
                            <h6>Cloud Services</h6>
                          </div>
                        </div>
              ...
              <li className="nav-item ms-3">
                <Link className="nav-link active" to="./careers">Career</Link>
              </li>
              <li className="nav-item ms-3">
                <Link className="nav-link active" to="./blogspage">Blogs</Link>
              </li>
            </ul>
      ...
      >
        ...
        <div className="offcanvas-body">
          <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li className="nav-item mb-2">
              <a className="nav-link active" href="#">Assistant</a>
            </li>
            <li className="nav-item dropdown mb-2">
              <a
                className="nav-link dropdown-toggle"
              ...
              <ul className="dropdown-menu" aria-labelledby="offcanvasServicesDropdown">
                ...
                <li><a className="dropdown-item" href="#">Cloud Services</a></li>
              </ul>
            </li>
            <li className="nav-item mb-2">
              <a className="nav-link active" href="#">Our work</a>
            ...
            <li className="nav-item mb-2">
              <a className="nav-link active" href="#">Hire Experts</a>
            </li>
            <li className="nav-item mb-4">
              <Link className="nav-link active" href="#">Blogs</Link>
            </li>
          </ul>
          <div className="heater-btn mb-2">
            <a href="#">Contact Us <i className="fa-solid fa-arrow-right ms-3"></i></a>
          </div>
        </div>
      </div>
    </div>

...
export const Case = () => {
  ...
  <div className="case-card-info">
    ...
    <p>
      SilkWater is a farming solution that takes care of the prime needs
      of a farmer. It enables the farmers to manage their budget,
      calculations, profit and loss in a more efficient way.
    </p>
  ...
  <div className="btn-group">
    <div className="btn-group-one me-3">
      ...
      <a href="#">Web App</a>
        ...
        <div className="case-card position-relative mb-5">
          ...
          <div className="case-card-info">
            ...
            <p>
              FarmFresh is an online platform that connects farmers with
              consumers, offering fresh produce directly from farms.
            </p>

...
//     const sections = document.querySelectorAll('.cardMainContainer');
//     const container = document.querySelector('.case-card-wrapper');
  
//     if (sections.length > 0) {
//       gsap.to(sections, {
//         xPercent: -100 * (sections.length - 1), // Moves horizontally
//         ease: 'none',
//         scrollTrigger: {
//           trigger: container, // Set the scrolling container
//           pin: true,
//           scrub: 3, // Smooth scrolling
//           snap: 1 / (sections.length - 1), // Snap to sections
//           end: () => `+=${container.offsetWidth}`, // End scroll based on width
//           invalidateOnRefresh: true,
//         },
//       });
//     }
...
//     return () => {
//       ScrollTrigger.killAll(); // Cleanup triggers on unmount
//     };
//   }, []);
...
//             <div className="cardMainContainer" key={caseItem.id}>
//               <div className="case-card position-relative mb-5">
//                 <div className="card-img">
//                   <img src={caseItem.mainImg} alt={caseItem.title} />
//                 </div>
//                 <div className="case-card-info">
...
//                 </div>
//                 <div className="btn-group">
//                   {caseItem.btnGroup.map((btnText, btnIndex) => (
//                     <div className="btn-group-one me-3" key={btnIndex}>
//                       <a href="#">{btnText}</a>
//                     </div>
//                   ))}
//                 </div>
